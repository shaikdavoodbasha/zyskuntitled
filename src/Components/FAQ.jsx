...
//                 <p className='text-[#101828] text-[32px] sm:text-[36px] font-[600] text-center'>Frequently asked questions</p>
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-10 px-4 sm:px-0'>
            ...
            <div className="w-full flex flex-col justify-center items-center gap-4 mt-12 bg-[#F9FAFB] rounded-[16px] p-6 sm:p-8 md:p-[32px]">
                <img src={avatargroup} alt="Avatar group" className="w-[80%] sm:w-auto" />
                ...
                <button className="bg-[#7F56D9] rounded-[8px] px-[16px] sm:px-[20px] py-[10px] sm:py-[12px] text-[#ffffff] text-[14px] sm:text-[16px] font-[400] hover:transition hover:bg-opacity-100 bg-opacity-80 duration-[.5s]">Get in touch</button>
            </div>
        </div>
    );
};
