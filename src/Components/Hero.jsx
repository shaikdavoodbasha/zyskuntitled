    ...
    return (
        <div className='flex flex-col justify-center items-center mt-14 gap-3 '>
            ...
            <div className='flex flex-col sm:flex sm:flex-row justify-center items-center gap-2 mt-8'>
                <div className='text-16px flex justify-center items-center border gap-2 border-[#D0D5DD] text-[#344054] rounded-[8px] sm:text-[18px] font-[600] sm:px-[28px] sm:py-[16px] px-[20px] py-[12px]'>
                    <div>
                        <FiPlayCircle />
                    </div>
                    <p>Demo</p>
                </div>
                <p className=' text-16px w-full bg-[#6941C6] sm:text-[18px] font-[600] text-[#ffffff] rounded-[8px] sm:px-[28px] sm:py-[16px]  px-[20px] py-[12px] hover:transition hover:bg-opacity-100  bg-opacity-80 duration-[.5s]'>Sign up</p>
            </div>
            <div className='mt-4'>
                <div>
