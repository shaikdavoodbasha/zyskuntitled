...
const Seconfeature = () => {
    ...
    return (
        <div className='mt-24 sm:mt-32 py-6 flex flex-col justify-center items-center gap-6 '>
            <p className='text-[12px] sm:text-[14px] font-[500] text-[#6941C6] border border-[#E9D7FE] px-[12px] py-[4px]  rounded-[16px]'>Feature</p>
            <h1 className='text-[#101828] text-[32px] sm:text-[36px] font-[600] text-center'>Cutting-edge features for advanced analytics</h1>
            <p className='text-[#475467] text-[18px] sm:text-[20px] font-[400] text-center max-w-[70vw] sm:max-w-[60vw]'>Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups.</p>
