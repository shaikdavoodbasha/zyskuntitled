...
const Seconfeature = () => {
    ...
    return (
        <div className='mt-24 sm:mt-32 py-6 flex flex-col justify-center items-center gap-6 '>
            ...
            <p className='text-[#475467] text-[18px] sm:text-[20px] font-[400] text-center max-w-[60vw]'>Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups.</p>
